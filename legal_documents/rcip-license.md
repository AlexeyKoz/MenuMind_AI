...
**Copyright © 2025 MenuMindAI - Alexey Kozlov**  
...
❌ You MAY NOT: Imply endorsement by MenuMindAI  
...
MenuMindAI grants you a perpetual, worldwide, royalty-free patent license to:
- Make, use, sell, and distribute RCIP implementations
- Practice any methods or processes in the RCIP specification

**This patent grant terminates if you sue MenuMindAI or any RCIP user for patent infringement related to RCIP.**
...
IN NO EVENT SHALL MENUMINDAI OR ALEXEY KOZLOV BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE RCIP SPECIFICATION OR THE USE OR OTHER DEALINGS IN THE SPECIFICATION.
...
- 📈 **MenuMindAI benefits:** More apps using RCIP means bigger ecosystem
...
- **Primary Author:** Alexey Kozlov (MenuMindAI)
- **Repository:** https://github.com/menumindai/rcip
- **Documentation:** https://docs.menumindai.com/rcip

### Proposing Changes

To propose changes or improvements:
1. Open GitHub issue at https://github.com/menumindai/rcip/issues
...
<footer>
  <p>Recipe format powered by 
     <a href="https://rcip.menumindai.com">RCIP</a> 
     by MenuMindAI
  </p>
</footer>
```
...
an open standard by MenuMindAI for representing recipes
in a machine-readable format.

Learn more: https://rcip.menumindai.com
```
...
This API uses RCIP (Recipe Interchange Protocol) by MenuMindAI
for all recipe data.

Specification: https://rcip.menumindai.com/spec
Documentation: https://docs.menumindai.com/rcip
```
...
MenuMindAI. Retrieved from https://rcip.menumindai.com
```
...
**A:** Alexey Kozlov / MenuMindAI maintains specification with community input.
...
- Created by Alexey Kozlov for MenuMindAI
...
✅ **Just attribute** - Credit MenuMindAI / Alexey Kozlov  
...
© 2025 MenuMindAI - Alexey Kozlov. All rights reserved.
